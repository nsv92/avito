 ...
 */
final class Version20230705114151 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE advert_category (id BIGINT NOT NULL, name VARCHAR(50) NOT NULL, description VARCHAR(150) DEFAULT NULL, slug VARCHAR(50) NOT NULL, PRIMARY KEY(id))');
